/* Estado, seleção de quadros e renderização do técnico. O movimento fornece
   os predicados físicos; esta aba aplica a animação e seu fallback. */
...
/* Prefer climb and jump frames before choosing run or walk. */
