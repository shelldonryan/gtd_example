/* Movimento do técnico: coordena entrada por quadro, gravidade, convés,
   escadas e passos. A entrada modal continua fora da física; os sons são
   disparados no ponto de movimento que os determina. */
