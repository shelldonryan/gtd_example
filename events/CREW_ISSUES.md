...
Uma crise de comida, conflito ou suporte de vida pode iniciar uma pessoa em
risco. Há no máximo uma pessoa em risco por vez. O prazo inicial é de 2 noites.
Socorrer é uma quest visível com custo
...
socorro é confirmado em um ponto fixo de socorro no Dormitório; o ponto não muda
conforme a pessoa em risco. A ação cobra o custo diretamente, sem etapa de
coleta, usa a conclusão diária das demais quests e fica indisponível quando há
um incidente novo.
